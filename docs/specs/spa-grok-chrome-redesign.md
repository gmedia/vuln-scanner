...
| Guide **§1.3.1** / handoff | Product-depth queue lists P15 as **#2–#3** after Uptime advanced (not GTM). | This epic is visual-only. | Do **not** reorder the historical P0–P14 table. P15 is **opt-in** (named + `buat`). **S1 before S2.** Pointer: guide §1.3.1 + §9. |
