...
def test_lab_script_safety_markers():
    ...
    assert "id:1140" in text
    assert "id:1141" in text
    assert "id:1142" in text
    assert "id:1143" in text
    ...
    assert "id:1150" in text
    assert "id:1151" in text
    assert "id:1152" in text
    assert "id:1153" in text
    assert "id:1154" in text
    assert "id:1155" in text
    assert "id:1156" in text
    assert "id:1157" in text
    assert "id:1158" in text
    assert "id:1159" in text
    assert "id:1160" in text
    assert "id:1161" in text
    assert "id:1162" in text
    assert "id:1163" in text
    assert "id:1164" in text
