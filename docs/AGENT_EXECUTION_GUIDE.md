...
| **— shipped** | **Scan PDF / invoice HTML print** | Browser print + invoice SPA print + **S2** `format=pdf` WeasyPrint | [`scan-pdf-invoice-print-v1.md`](specs/scan-pdf-invoice-print-v1.md) S0 + **S1a #785** + **S1b #786** + **S2 this PR** | Do **not** re-implement; invoice PDF still I10 **out** |
...
| **3** | **WAF 1147+** own pack | Next original rule IDs after **1001–1146**. Out: CRS / IM360 commercial DB; P14 **G/H** (research). | [`host-waf-v1.md`](specs/host-waf-v1.md) · [`imunify-class-onbox.md`](specs/imunify-class-onbox.md) | CRS/IM360 in git; paste onto `sinexis.app` edge; G/H clone |
...
**Still parked (not in this queue):** Capacitor/PWA [`capacitor-shell-v1.md`](specs/capacitor-shell-v1.md); AI Gateway already S1–S5 flag-off; cPanel plugin; PHP PD; org wallet; nested projects; P14 **G/H** (research only); invoice PDF (I10); 24×7 YARA on `/`.
...
| [`docs/specs/scan-pdf-invoice-print-v1.md`](specs/scan-pdf-invoice-print-v1.md) | **S0 + S1a #785 + S1b #786 + S2 shipped** | Browser print + WeasyPrint `format=pdf`. Invoice PDF still I10 **out**. |
...
| “buat” scan PDF / invoice print / S1a / S1b | **Shipped** #785/#786 — [`scan-pdf-invoice-print-v1.md`](specs/scan-pdf-invoice-print-v1.md). Clarify bug / residual only. **Print S2 shipped** (`format=pdf` / WeasyPrint). Invoice PDF still I10 **out** |
...
| “buat Print S2” / `format=pdf` / WeasyPrint | **Shipped** this PR. Invoice PDF still I10 **out**. Do **not** re-implement |
...
| `docs/specs/scan-pdf-invoice-print-v1.md` | **S0 + S1a #785 + S1b #786 + S2 shipped.** Browser print + WeasyPrint `format=pdf`. Invoice PDF still I10 **out** |
