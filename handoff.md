...
| **P8 Uptime** | **S1–S5 on `main`** (#397). Spek [`docs/specs/uptime-v1.md`](docs/specs/uptime-v1.md). Ops [`docs/uptime-ops.md`](docs/uptime-ops.md). Residual: edge Alembic + `worker_uptime` smoke (human). |
