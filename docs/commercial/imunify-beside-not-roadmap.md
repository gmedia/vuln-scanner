...
| HTTP filter | Host WAF detect + **protect** (Host Multi; customer nginx). Tab/list = **starter 1001–1032**; live ingest email **#659** | Coraza on `sinexis.app`, full CRS / Imunify rule IDs as product events |
