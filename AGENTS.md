...
- **Owner (2026-09-15):** chat user is **product**, not AM. After reset, recommend **product-depth** slices in guide **§1.3.1** (default: **P15 S2**; Uptime advanced **shipped**). **Do not** pitch GTM / wave-1 email / 10 SIDs as next work unless the user asks.
