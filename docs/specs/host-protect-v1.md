...
| **D2** | Positioning | **Attach beside** Imunify where panel already has it; **primary / displace-lite** on GMD VPS/colo **without** a panel suite — after [`vps-displace-imunify-dev-plan.md`](vps-displace-imunify-dev-plan.md) **Sentence-ok** (**OPEN** — §7; not pack-in-git). **Not** “rip Imunify on cPanel shared.” |
