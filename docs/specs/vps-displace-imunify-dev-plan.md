...
2. Simulate hidden **or** rows labeled `preview` / `lab`; no unlabeled `mock.sqli.1` in customer UX (**DL0 shipped** #647). Live ingest **1001–1149**.
...
| HTTP WAF | Starter **1001–1149** | Further original IDs only; never IM360/CRS |
...
| DL2 pack **1005** / **1006** | #651; live ingest **1001–1149** |
