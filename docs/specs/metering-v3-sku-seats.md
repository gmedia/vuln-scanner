...
- Do **not** render `costPreview` / `creditDisplay` on IP, domain, or mobile forms. Meter is SKU seats.
...
- Dropping `credits` column or deleting `/credit-history` (later; page stays, chrome gone).
